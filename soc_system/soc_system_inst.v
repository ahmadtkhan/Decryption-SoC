	soc_system u0 (
		...
		.md5_control_readdata            (<connected-to-md5_control_readdata>),            //     md5_control.readdata
		.md5_control_readdata1           (<connected-to-md5_control_readdata1>),           //                .readdata1
		.md5_control_writebyteenable_n   (<connected-to-md5_control_writebyteenable_n>),   //                .writebyteenable_n
		.md5_data_readdata               (<connected-to-md5_data_readdata>),               //        md5_data.readdata
		.md5_data_readdata1              (<connected-to-md5_data_readdata1>),              //                .readdata1
		.md5_data_writebyteenable_n      (<connected-to-md5_data_writebyteenable_n>),      //                .writebyteenable_n
		.md5_data_readdata2              (<connected-to-md5_data_readdata2>),              //                .readdata2
		.seg7_if_0_export                (<connected-to-seg7_if_0_export>)                 //       seg7_if_0.export
	);
